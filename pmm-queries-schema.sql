...
(
    digest String COMMENT 'hash of query fingerprint',
    digest_text String COMMENT 'query fingerprint',
    db_server String COMMENT 'IP or hostname of DB server',
    db_schema String COMMENT 'database or collection name',
    db_username String COMMENT 'client user name',
    ...
    m_qc_hit_sum Float32 COMMENT 'Boolean metrics sum == cnt',
...
ORDER BY (period_start, digest, db_server, db_username, db_schema, client_host)
